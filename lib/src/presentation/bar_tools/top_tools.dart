...
class BottomPageTools extends StatefulWidget {
  final GlobalKey contentKey;
  final BuildContext context;
  final Function? renderWidget;
  const BottomPageTools(
      {super.key,
      required this.contentKey,
      required this.context,
      this.renderWidget});
  ...
  @override
  _BottomPageToolsState createState() => _BottomPageToolsState();
}

class _BottomPageToolsState extends State<BottomPageTools> {
  @override
  Widget build(BuildContext context) {
    return Consumer3<ControlNotifier, PaintingNotifier,
        DraggableWidgetNotifier>(
